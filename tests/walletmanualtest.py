...
print(result)
calldict["participantid"] = participantid
r = requests.post(APIURL+'issue_ticket', json=calldict)
result = r.json()
print(result)
name = input("please do the interaction in the wallet")
# list participants
...
# do check in
calldict["participantid"] = participantid
r = requests.post(APIURL+'get_checkin_token', json=calldict)
result = r.json()
print(result)
name = input("please do the interaction in the wallet to check the ticket")
# list participants
calldict = {"token": token, "eventid": eventid}
r = requests.post(APIURL+'list_participants', json=calldict)
result = r.json()
